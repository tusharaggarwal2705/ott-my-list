...
export class MongooseMovieContentRepository implements ContentRepository {
  constructor(
    @InjectModel(MovieContent.name)
    private readonly contentModel: Model<MovieDocument>,
  ) {}
...
export class MongooseTVShowContentRepository implements ContentRepository {
  constructor(
    @InjectModel(TVShowContent.name)
    private readonly contentModel: Model<TVShowDocument>,
  ) {}
